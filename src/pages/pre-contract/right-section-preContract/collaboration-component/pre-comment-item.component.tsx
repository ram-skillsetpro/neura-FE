import DeleteIcon from "core/components/svg/delete-icon";
import PlusIcon from "core/components/svg/plus-icon";
import { useAppDispatch } from "core/hook";
import { convertKeysToCamel, getAuth, getShortUsername, getUsernameColor } from "core/utils";
import { useAuthorityCheck } from "core/utils/use-authority-check.hook";
import DOMPurify from "dompurify";
import { CommentType, ConvertedReplyType, ReplyType } from "pages/comment/comment-box.model";
...
import "./pre-comment-item.styles.scss";

interface PreCommentItemType {
  comment: CommentType;
  fileId: number;
  scrollToBottom: () => void;
  index: number;
...
const PreCommentItem: React.FC<PreCommentItemType> = ({
  comment,
  fileId,
  scrollToBottom,
  index,
