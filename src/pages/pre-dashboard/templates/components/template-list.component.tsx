...
import { deleteTemplate, getTemplatesPerPage } from "pages/pre-dashboard/templates/templates.redux";
...
import { TOAST, USER_AUTHORITY } from "src/const";
...
const TemplateListView: React.FC<TemplateListViewProps> = ({ isFilterActive }) => {
          ...
          {activeFileOption === data.id && (
            <div className="dropdown-container">
              <div className="dropdown-box">
                <ul>
                  {auth.profileId === data.createdBy && isContractCreator ? (
                    <>
                      <li
                      ...
                      <li className="border-bottom" onClick={() => toggleStatus(data.id)}>
                        Delete
                      </li>
                    </>
                  ) : (
